...
public class SecurityConfig {
    ...
    //     UserDetails user1 = User.withDefaultPasswordEncoder().withUsername("admin123").password("admin123").roles("ADMIN", "USER").build();
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        ...
        // by default it is get method but logout required post method because it is secure with csrf so we have to desable csrf
